#!/usr/bin/env python3
"""
Standalone Microservice Webhook Adapter for sovereign-telemetry-reports
Listens on port 8793 and translates n8n requests into deterministic engine executions.
"""
import sys
import os
import json
...
def run():
    server = HTTPServer(("0.0.0.0", 8793), WebhookHandler)
    print(f"[Sovereign Telemetry Reports] Webhook Adapter listening on http://0.0.0.0:8793")
